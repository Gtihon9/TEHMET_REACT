			...
			<div className="layout">
				<div className="container">
					...
					<p>
						...
						<strong>tehmetservice.ru</strong> (а также его субдоменах), может получить о
						Пользователе во время использования сайта tehmetservice.ru (а также его
					...
					<p>
						1.1.5. «Сайт <strong> Техметсервис</strong>» - это совокупность связанных между
						собой веб-страниц, размещенных в сети Интернет по уникальному адресу (URL):{" "}
						<strong>tehmetservice.ru</strong>, а также его субдоменах.
					</p>

					<p>
						1.1.6. «Субдомены» - это страницы или совокупность страниц, расположенные на
						доменах третьего уровня, принадлежащие сайту Техметсервис, а также другие
					...
					<p>
						...
						лицо, имеющее доступ к сайту <strong>Техметсервис</strong>, посредством сети
						Интернет и использующее информацию, материалы и продукты сайта{" "}
						<strong>Техметсервис</strong>.
					</p>
					...
					<p>
						1.1.8. «IP-адрес» — уникальный сетевой адрес узла в компьютерной сети, через
						который Пользователь получает доступ на Сайт.
					</p>
					...
					<p>
						...
						должен прекратить использование сайта Техметсервис .
					</p>

					<p>
						2.3. Настоящая Политика конфиденциальности применяется к сайту Техметсервис. Сайт
						не контролирует и не несет ответственность за сайты третьих лиц, на которые
						Пользователь может перейти по ссылкам, доступным на сайте Техметсервис.
					</p>
					...
					<p>
						...
						при регистрации на сайте Техметсервис, при подписке на информационную e-mail
						рассылку или при оформлении заказа.
					</p>
					...
					<p>
						...
						<br />
						4.1.1. Идентификации Пользователя, зарегистрированного на сайте Техметсервис для
						...
						уведомлений, запросов, касающихся использования сайта Техметсервис, оказания услуг
					...
					<p>
						...
						целях выполнения заказа Пользователя, оформленного на сайте Техметсервис, включая
					...
					<p>
						...
						необходимых для использования сайта Техметсервис, и давать согласие на их
						обработку.
					</p>
					...
					<p>
						...
						доступ как к части сайта Техметсервис, несет лицо, предоставившее такую
						информацию.
					</p>
					...
					<p>
						...
						публичном доступе на сайте Техметсервис) допускается их распространение при
						условии, что будет дана ссылка на Сайт.
					</p>
					...
					<p>
						...
						претензии, письменно или в электронном виде уведомляет заявителя претензии о
					...
					<p>
						...
						http://tehmetservice.ru/politika.html
					</p>

					<p>Обновлено: 30 Августа 2023 года</p>
					<p>г. Москва, ОГРН 1035009566822 ИНН 5047048624</p>
				</div>
			</div>
		</motion.main>
	)
