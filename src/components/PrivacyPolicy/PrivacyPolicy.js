		...
		>
			<div className="layout">
				...
				<p>
					...
					<strong>Техметсервис</strong>, (далее – Сайт) расположенный на доменном имени{" "}
					<strong>https://tehmetservice.ru/</strong> (а также его субдоменах), может получить о
					Пользователе во время использования сайта https://tehmetservice.ru/ (а также его
				...
				<p>
					...
					уполномоченные сотрудники на управление сайтом <strong>Техметсервис</strong>,
					действующие от имени ООО «Техметсервис» , которые организуют и (или) осуществляют
				...
				<p>
					1.1.5. «Сайт <strong> Техметсервис</strong>» - это совокупность связанных между собой
					веб-страниц, размещенных в сети Интернет по уникальному адресу (URL):{" "}
					<strong>https://tehmetservice.ru/</strong>, а также его субдоменах.
				</p>

				<p>
					1.1.6. «Субдомены» - это страницы или совокупность страниц, расположенные на доменах
					третьего уровня, принадлежащие сайту Техметсервис, а также другие временные страницы,
					внизу который указана контактная информация Администрации
				</p>

				<p>
					1.1.5. «Пользователь сайта <strong>Техметсервис</strong> » (далее Пользователь) –
					лицо, имеющее доступ к сайту <strong>Техметсервис</strong>, посредством сети Интернет
					и использующее информацию, материалы и продукты сайта <strong>Техметсервис</strong>.
				</p>
				...
				<p>
					1.1.9. «Товар » - продукт, который Пользователь заказывает на сайте и оплачивает
					через платёжные системы.
				</p>

				<h2>2. Общие положения</h2>
				<p>
					2.1. Использование сайта Техметсервис Пользователем означает согласие с настоящей
				...
				<p>
					...
					прекратить использование сайта Техметсервис .
				</p>

				<p>
					2.3. Настоящая Политика конфиденциальности применяется к сайту Техметсервис. Сайт не
					контролирует и не несет ответственность за сайты третьих лиц, на которые Пользователь
					может перейти по ссылкам, доступным на сайте Техметсервис.
				</p>
				...
				<p>
					...
					Техметсервис, при подписке на информационную e-mail рассылку или при оформлении
					заказа.
				</p>
				...
				<p>
					...
					Техметсервис и включают в себя следующую информацию:
					<br />
				...
				<p>
					...
					Техметсервис, требующим авторизации.
				</p>

				<p>
					3.3.2. Сайт осуществляет сбор статистики об IP-адресах своих посетителей. Данная
					информация используется с целью предотвращения, выявления и решения технических
					проблем.
				</p>
				<p>
				...
				<p>
					...
					<br />
					4.1.1. Идентификации Пользователя, зарегистрированного на сайте Техметсервис для его
					...
					запросов, касающихся использования сайта Техметсервис, оказания услуг и обработки
					...
					Пользователем.
					<br />
					4.1.6. Создания учетной записи для использования частей сайта Техметсервис, если
					...
					возникновении проблем, связанных с использованием сайта Техметсервис.
					<br />
					4.1.9. Предоставления Пользователю с его согласия специальных предложений, информации
					о ценах, новостной рассылки и иных сведений от имени сайта Техметсервис.
					<br />
				...
				<p>
					5.2. Пользователь соглашается с тем, что Администрация вправе передавать персональные
					данные третьим лицам, в частности, курьерским службам, организациями почтовой связи
					(в том числе электронной), операторам электросвязи, исключительно в целях выполнения
					заказа Пользователя, оформленного на сайте Техметсервис, включая доставку Товара,
				...
				<p>
					...
					необходимых для использования сайта Техметсервис, и давать согласие на их обработку.
				</p>
				...
				<p>
					...
					как к части сайта Техметсервис, несет лицо, предоставившее такую информацию.
				</p>

				<p>
					7.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта
					Техметсервис, может являться объектом интеллектуальной собственности, права на
					который защищены и принадлежат другим Пользователям, партнерам или рекламодателям,
					которые размещают такую информацию на сайте Техметсервис. <br />
				...
				<p>
					...
					публичном доступе на сайте Техметсервис) допускается их распространение при условии,
				...
				<p>
					...
					сайте Техметсервис или передаваемых через него.
				</p>
				...
				<p>
					...
					пользователем на сайте Техметсервис, включая, но не ограничиваясь: информацию,
				...
				<p>
					...
					сайте Техметсервис, если иное не предусмотрено новой редакцией Политики
					конфиденциальности.
				</p>

				<p>
					9.3. Все предложения или вопросы касательно настоящей Политики конфиденциальности
					следует сообщать по адресу: d.fomenko@tehmetservice.ru
				</p>

				<p>
					9.4. Действующая Политика конфиденциальности размещена на странице по адресу
					http://https://tehmetservice.ru//politika.html
				</p>

				<p>Обновлено: 24 Августа 2023 года</p>
				<p>г. Москва, ООО «Техметсервис» ОГРН 1035009566822</p>
			</div>
		</motion.main>
	)
}
