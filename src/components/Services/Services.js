					...
					{loading ? (
						...
						<div className="services-error-wrapper">
							<Error
								...
								message="Мы хотели бы сообщить Вам, что услуги нашей компании в настоящее время находятся в процессе добавления на наш сайт и пока не видны. Мы просим свои извинения."
							/>
						</div>
					) : (
						<>
